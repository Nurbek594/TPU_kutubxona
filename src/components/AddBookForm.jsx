...
function AddBookForm({ onAddBook }) {
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
      <h2 className="text-2xl font-bold text-slate-900">Yangi kitob qo‘shish</h2>
      <p className="mt-2 text-slate-600">
        Kutubxona katalogiga yangi kitob ma’lumotlarini kiriting.
      </p>
      ...
      <form onSubmit={handleSubmit} className="mt-8 grid gap-5 md:grid-cols-2">
        ...
        <input
          ...
          value={form.rating}
          onChange={handleChange}
          placeholder="Reyting (masalan 4.8)"
          className="rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-blue-600"
          required
        />
